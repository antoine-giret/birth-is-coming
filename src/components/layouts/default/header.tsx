      ...
      <div className="shrink-0 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-3">
          ...
          <div className="ml-4 flex items-center md:ml-6">
            {currentUser === null ? (
              <Button isRouterLink href="/sign-in" label="Se connecter" variant="contained" />
            ) : (
              currentUser && (
                <Menu as="div" className="relative ml-3">
                  <div>
                    <MenuButton
                      className="relative flex max-w-xs items-center rounded-full bg-indigo-500 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-500 justify-center w-8 h-8 overflow-hidden"
